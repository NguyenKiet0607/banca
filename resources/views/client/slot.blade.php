                ...
                <div class="skiptranslate goog-te-gadget" dir="ltr" style="">
                  <div id=":0.targetLanguage">
                    ...
                    <a class="VIpgJd-ZVi9od-l4eHX-hSRGPd" href="https://translate.google.com/" target="_blank">
                      <img src="{{ asset('images/googlelogo_color_42x16dp.png') }}" width="37px" height="14px" style="padding-right: 3px" alt="Google Dịch">Dịch </a>
                  </span>
                </div>
              </div>
            </div>
    ...
    <div id="goog-gt-tt" class="VIpgJd-yAWNEb-L7lbkb skiptranslate" style="border-radius: 12px; margin: 0 0 0 -23px; padding: 0; font-family: &#39;Google Sans&#39;, Arial, sans-serif;" data-id="">
      <div id="goog-gt-vt" class="VIpgJd-yAWNEb-hvhgNd">
        ...
        <div id="goog-gt-votingHiddenPane" class="VIpgJd-yAWNEb-hvhgNd-aXYTce">
          <form id="goog-gt-votingForm" action="https://translate.googleapis.com/translate_voting?client=te" method="post" target="votingFrame" class="VIpgJd-yAWNEb-hvhgNd-aXYTce">
          ...
          <!-- <iframe name="votingFrame" frameborder="0" src="./pg2-dien-tu_files/saved_resource.html"></iframe> -->
        </div>
      </div>
    </div>
