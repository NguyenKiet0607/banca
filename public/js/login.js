...
(() => {
    ...
    n.d = (e, t) => {
        ...
        var Yd = {
            ...
            }, [_s('<div style="background: #000;color: #fff;text-align: center;padding: 10px 20px;"><div class="aa">Liên hệ</div><div><img width="20px" src="../images/telegram-logo.svg"/>Telegram: <a href="https://t.me/tophackchamvip">@tophackchamvip</a></div></div>')], -1);
        var eh = {
